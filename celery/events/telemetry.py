...
class EventAnalytics:
    ...
    def _detect_anomalies(self, current_data: historical_data: Dict) -> list[Dict]:
...
def get_event_analytics(event_dispatcher: TelemetryIntegratedEventDispatcher) -> EventAnalytics | None:
